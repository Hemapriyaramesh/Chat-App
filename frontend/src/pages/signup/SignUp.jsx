      ...
      <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <input type="text" placeholder='Hema' className='w-full input input-bordered h-10' value={inputs.fullName}
          ...
          <div>
            ...
            <input type="text" placeholder='hema' className='w-full input input-bordered h-10' 
